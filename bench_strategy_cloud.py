...
CHANNEL_SPEC = PIMChannelSpec(
    compute_power=4*2,           # 16 TOPS (cloud server)
    shared_bandwidth=20.8,       # DDR5 5200MT/s
    memory_bandwidth=0.4*2,        # 1.6 TB/s
)
...
MODELS = ["Qwen3-32B","GLM4-32B","Yi-34B","Meta-Llama-3-70B"]
